      ...
      >
        ...
        <header className="fixed top-0 w-full z-50 bg-[#0a0e16] border-b border-outline-variant flex justify-between items-center px-4 md:px-grid-margin h-16 max-w-full backdrop-blur-md">
          ...
          <div className="flex items-center gap-4">
            <button 
              className="text-primary md:hidden p-2 focus:outline-none"
        ...
        {isMenuOpen && (
          <div className="fixed top-16 left-0 w-full bg-[#0a0e16]/95 border-b border-outline-variant backdrop-blur-md z-40 p-6 flex flex-col gap-4 text-on-surface shadow-2xl">
            <a 
              href="#capabilities" 
              onClick={() => setIsMenuOpen(false)}
              className="font-label-sm uppercase tracking-wider text-on-surface hover:text-primary py-3 border-b border-outline-variant/30 flex justify-between items-center"
            >
              Capabilities <span className="material-symbols-outlined text-sm">arrow_forward</span>
            </a>
            <a 
              href="#ai-development" 
              onClick={() => setIsMenuOpen(false)}
              className="font-label-sm uppercase tracking-wider text-on-surface hover:text-primary py-3 border-b border-outline-variant/30 flex justify-between items-center"
            >
              AI Development <span className="material-symbols-outlined text-sm">arrow_forward</span>
            </a>
            <a 
              href="#transformation" 
              onClick={() => setIsMenuOpen(false)}
              className="font-label-sm uppercase tracking-wider text-on-surface hover:text-primary py-3 border-b border-outline-variant/30 flex justify-between items-center"
            >
              Transformation <span className="material-symbols-outlined text-sm">arrow_forward</span>
            </a>
            <a 
              href="#about" 
              onClick={() => setIsMenuOpen(false)}
            ...
            <a 
              href="#contact" 
              onClick={() => setIsMenuOpen(false)}
              className="bg-primary text-white text-center py-4 font-label-sm uppercase tracking-wider font-bold rounded-sm mt-2 flex justify-between items-center px-4"
            >
              Start a Conversation <span className="material-symbols-outlined text-sm">arrow_forward</span>
            </a>
          </div>
        )}
        ...
        <main className="pt-24 px-4 md:px-8 max-w-7xl mx-auto flex flex-col gap-16 md:gap-section-gap overflow-hidden w-full">
          ...
          <section className="relative pt-8 pb-8 flex flex-col gap-6 border-b border-outline-variant w-full">
            <div className="inline-flex items-center gap-2 border border-outline-variant px-3 py-1 w-max rounded-sm">
              <span className="w-2 h-2 bg-primary rounded-full relative top-0 left-0"></span>
            ...
            <div className="flex flex-col gap-4 mt-4 w-full">
              <a href="#contact" className="bg-primary-container text-white px-6 py-4 rounded-sm font-label-sm uppercase tracking-wider hover:bg-primary transition-colors flex justify-between items-center w-full">
                Start a Transformation
                <span className="material-symbols-outlined">arrow_forward</span>
              </a>
              <a href="#capabilities" className="border border-outline-variant text-white px-6 py-4 rounded-sm font-label-sm uppercase tracking-wider hover:bg-surface-container transition-colors w-full text-center">
          ...
          <section className="flex flex-col gap-6 w-full">
            ...
            <a href="#capabilities" className="bg-primary-container text-white p-6 mt-4 border-l-4 border-white w-full block hover:bg-primary transition-colors">
              <h4 className="font-headline-md text-xl uppercase tracking-wider">THIS IS WHERE MAVYAX COMES IN.</h4>
            </a>
          </section>

          {/* 5. CORE CAPABILITIES */}
          <section id="capabilities" className="scroll-mt-20 flex flex-col gap-8 w-full">
            ...
            <div className="grid grid-cols-1 gap-4 w-full">
              <a href="#ai-development" className="border border-outline-variant bg-surface-container-lowest p-6 flex flex-col gap-6 hover:border-primary transition-colors group">
                ...
                <h4 className="font-headline-md text-white group-hover:text-primary transition-colors">AI Development</h4>
              </a>
              <a href="#transformation" className="border border-outline-variant bg-surface-container-lowest p-6 flex flex-col gap-6 hover:border-primary transition-colors group">
                <div className="flex justify-between items-start">
                ...
                <h4 className="font-headline-md text-white group-hover:text-primary transition-colors">Business IT Transformation</h4>
              </a>
            </div>
          </section>

          {/* 6. AI DEVELOPMENT PILLAR */}
          <section id="ai-development" className="scroll-mt-20 flex flex-col gap-8 w-full">
          ...
          <section id="transformation" className="scroll-mt-20 flex flex-col gap-8 w-full">
            <div className="flex items-center gap-4 border-b border-outline-variant pb-4">
          ...
          {/* 13. PHILOSOPHY / ABOUT */}
          <section id="about" className="scroll-mt-20 flex flex-col gap-8 w-full pb-16">
        ...
        <footer className="mt-16 bg-surface-container-lowest border-t border-outline-variant pt-12 pb-24 px-6 w-full flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-4">
            <a className="text-on-surface-variant font-label-sm uppercase tracking-wider hover:text-primary transition-colors" href="#capabilities">Capabilities</a>
            <a className="text-on-surface-variant font-label-sm uppercase tracking-wider hover:text-primary transition-colors" href="#ai-development">AI Development</a>
            <a className="text-on-surface-variant font-label-sm uppercase tracking-wider hover:text-primary transition-colors" href="#transformation">Transformation</a>
            <a className="text-on-surface-variant font-label-sm uppercase tracking-wider hover:text-primary transition-colors" href="#about">About</a>
            <a className="text-on-surface-variant font-label-sm uppercase tracking-wider hover:text-primary transition-colors" href="#contact">Contact</a>
          </div>
          <div className="flex flex-col gap-2 font-label-sm text-on-surface-variant">
            <p>Mavyax Tech Private Limited</p>
            <p><a href="tel:+918925687688" className="hover:text-primary transition-colors">+91 8925687688</a></p>
            <p><a href="mailto:info@mavyax.com" className="hover:text-primary transition-colors">info@mavyax.com</a></p>
