  ...
  return (
    <main className="min-h-screen" id="top">
      ...
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-outline-variant">
        <div className="flex justify-between items-center h-20 px-grid-margin max-w-[1600px] mx-auto">
          ...
          <div className="hidden md:flex gap-component-gap font-body-md text-body-md">
            ...
            <a className="text-on-surface-variant hover:text-primary transition-colors" href="#ai-development">AI</a>
            <a className="text-on-surface-variant hover:text-primary transition-colors" href="#transformation">Transformation</a>
            <a className="text-on-surface-variant hover:text-primary transition-colors" href="#about">About</a>
          </div>
          <a href="#contact" className="bg-primary text-white px-6 py-2 font-label-sm text-label-sm uppercase hover:opacity-90 transition-opacity flex items-center justify-center">
      ...
      <section className="py-32 px-grid-margin max-w-[1600px] mx-auto border-t border-outline-variant">
        ...
        <a href="#capabilities" className="block bg-primary text-white text-center py-4 font-label-sm uppercase tracking-widest font-bold hover:opacity-90 transition-opacity">
          THIS IS WHERE MAVYAX COMES IN.
        </a>
      </section>

      {/* 5. Core Capabilities */}
      <section id="capabilities" className="scroll-mt-24 py-32 px-grid-margin max-w-[1600px] mx-auto border-t border-outline-variant">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
          <a href="#ai-development" className="border border-outline-variant p-12 bg-surface text-center hover:border-primary transition-colors flex flex-col items-center justify-center group">
            ...
            <h3 className="font-headline-md text-headline-md text-on-surface mb-4 group-hover:text-primary transition-colors">AI DEVELOPMENT</h3>
          </a>
          <a href="#transformation" className="border border-outline-variant p-12 bg-surface text-center hover:border-primary transition-colors flex flex-col items-center justify-center group">
            ...
            <h3 className="font-headline-md text-headline-md text-on-surface mb-4 group-hover:text-primary transition-colors">BUSINESS IT TRANSFORMATION</h3>
          </a>
        </div>
      </section>

      {/* 6. AI Development */}
      <section id="ai-development" className="scroll-mt-24 py-32 px-grid-margin max-w-[1600px] mx-auto border-t border-outline-variant">
      ...
      <section id="transformation" className="scroll-mt-24 py-32 px-grid-margin max-w-[1600px] mx-auto border-t border-outline-variant">
        <h2 className="font-headline-xl text-headline-xl text-on-surface mb-16">
      ...
      {/* 13. Philosophy / About */}
      <section id="about" className="scroll-mt-24 py-32 px-grid-margin max-w-[1600px] mx-auto border-t border-outline-variant">
      ...
      {/* 14. Final CTA */}
      <section id="contact" className="scroll-mt-24 py-32 px-grid-margin max-w-[1600px] mx-auto border-t border-outline-variant">
        <div className="border border-primary/30 bg-surface-dim grid-bg p-12 md:p-20 text-center relative overflow-hidden">
          <div className="relative z-10">
            ...
            <a href="mailto:info@mavyax.com" className="bg-primary text-white px-10 py-4 font-label-sm text-label-sm uppercase tracking-wider hover:bg-opacity-90 transition-all inline-flex items-center gap-2 mx-auto">
              START A CONVERSATION
        ...
        <div className="grid grid-cols-12 gap-gutter px-grid-margin max-w-[1600px] mx-auto">
          ...
          <div className="col-span-12 md:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-on-surface-variant">
            <div className="flex flex-col gap-2">
              ...
              <a className="hover:text-primary transition-colors" href="#capabilities">Capabilities</a>
              <a className="hover:text-primary transition-colors" href="#ai-development">AI Development</a>
              <a className="hover:text-primary transition-colors" href="#transformation">Transformation</a>
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="tel:+918925687688" className="hover:text-primary transition-colors">+91 8925687688</a>
              <a href="mailto:info@mavyax.com" className="hover:text-primary transition-colors">info@mavyax.com</a>
            </div>
            <div className="flex flex-col gap-2">
